...
GUICtrlSetData(-1, "$CA_GETCURRENTTARGET|$CA_GETMYID|$CA_CASTING|$CA_SKILLRECHARGE|$CA_SKILLADRENALINE|$CA_STOREVAR|$CA_SETLOGANDHWND|"& _
					...
					"$CA_ACCEPTALLITEMS|$CA_SETENGINEHOOK|$CA_GETSTORAGE1ITEMID|$CA_GETSTORAGE2ITEMID|$CA_GETSTORAGE3ITEMID|$CA_GETSTORAGE4ITEMID|"& _
					"$CA_GETSTORAGE1ITEMINFO|$CA_GETSTORAGE2ITEMINFO|$CA_GETSTORAGE3ITEMINFO|$CA_GETSTORAGE4ITEMINFO")
