...
GUICtrlSetData(-1,	"$CA_GetRegionAndLanguage|$CA_TraderRequest|$CA_TraderCheck|$CA_TraderBuy|$CA_TraderRequestSell|$CA_TraderRequestSellById|$CA_TraderSell|"& _
					...
					"$CA_GetHeroSkillId|$CA_GetHeroAgentId|$CA_GetNearestAliveEnemyToCoordsByPlayerNumber|$CA_GetNearestAliveAgentByPlayerNumber|"& _
					"$CA_PrepareZoneMapEx|$CA_ZoneMapEx")
