...
GUICtrlSetData(-1, "$CA_GETCURRENTTARGET|$CA_GETMYID|$CA_CASTING|$CA_SKILLRECHARGE|$CA_SKILLADRENALINE|$CA_STOREVAR|$CA_SETLOGANDHWND|"& _
					...
					"$CA_GETTITLEKURZICK|$CA_RESIGN|$CA_RETURNTOOUTPOST|$CA_USEITEM|$CA_USEITEMBYID|$CA_GETLASTDIALOGID|$CA_DROPITEM|$CA_DROPITEMBYID|"& _
					"$CA_ACCEPTALLITEMS|$CA_SETENGINEHOOK")
